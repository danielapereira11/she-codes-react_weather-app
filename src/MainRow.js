      ...
      <div className="col">
        ...
        <div className="row">
          <div className="col-12">
            <h2 id="current-city">Guimarães</h2>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-5 align-self-center">
            <div className="today-current-date-time">
              <p>
                <span id="current-date">Sun, March 13</span>
                <br />
          ...
          <div className="col-5 col-sm-4 today">
            <span id="today-current-temp">
              <span id="current-temp-value">12</span>
              <span>
                <a
                  href="/"
                  id="celcius-link"
        ...
        <div className="row justify-content-start today-current-weather">
          ...
          <div className="col align-self-center">
            <p>
              <span className="wind-speed">Wind Speed: 0.45 </span>
